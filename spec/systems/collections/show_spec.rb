...
RSpec.describe 'Collections#show', type: :system do
  ...
  after(:all) do
    parent_directory = Rails.root.join('repos', @repo.author_username, @repo.owner)
  ...
  context 'when repository is set to banned = false' do
    ...
    it 'displays Markdown text in HTML' do
      visit '/collections/user/user/markdown-templates/pages/chapter-1/chapter-1-article-1'
    ...
    it 'displays embedded code files' do
      visit '/collections/user/user/markdown-templates/pages/chapter-2/chapter-2-article-1'
    ...
    it 'does not render content from an HTML file with the same name' do
      visit '/collections/user/user/markdown-templates/pages/chapter-2/chapter-2-article-2'
    ...
    context 'when marp == true in front-matter' do
      before do
        visit '/collections/user/user/markdown-templates/pages/chapter-3/marp-slides'
      end
